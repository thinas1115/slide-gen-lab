...
def _large_diagram():
    ...
    return {
        ...
        "channels": {
            ...
            "left_of_app": ["left_of_col", "app"],
            "right_of_service": ["right_of_col", "service"],
...
def _large_aws_diagram():
    return {
        ...
        "channels": {
            ...
            "left_compute": ["left_of_col", "compute_a"],
            "right_compute": ["right_of_col", "compute_b"],
            "private_left": ["outside_container", ["private", "left"]],
            "private_right": ["outside_container", ["private", "right"]],
            "cloud_right": ["outside_container", ["cloud", "right"]],
        },
        "edges": [
            ...
            {"from": "r53", "to": "cf", "exit": "left", "enter": "left",
             "via": ["cloud_left"], "dash": "dash"},
            {"from": "knowledge", "to": "bedrock", "label": "参照データ",
             "dash": "dash"},
            {"from": "cf", "to": "alb"},
            {"from": "alb", "to": "api"},
            {"from": "api", "to": "queue", "exit": "left", "enter": "right"},
            {"from": "queue", "to": "worker_a"},
            {"from": "worker_a", "to": "worker_b", "label": "並列処理"},
            {"from": "ecr", "to": "worker_a", "exit": "left", "enter": "left",
             "via": ["left_compute"], "dash": "dash"},
            {"from": "bedrock", "to": "worker_b", "exit": "right", "enter": "right",
             "via": ["right_compute"], "dash": "dash"},
            {"from": "worker_a", "to": "rds_a", "exit": "left", "enter": "left",
             "via": ["private_left"]},
            {"from": "worker_b", "to": "rds_b", "exit": "right", "enter": "right",
             "via": ["private_right"]},
            ...
            {"from": "ddb", "to": "archive", "exit": "right", "enter": "right",
             "via": ["cloud_right"], "dash": "dash"},
            {"from": "@private", "from_row": "data", "to": "cw", "dash": "dash"},
        ],
    }
