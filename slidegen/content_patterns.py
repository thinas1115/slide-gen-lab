            ...
            "diagram": {
                ...
                "edges": [
                    {"from": "client", "to": "fw", "label": "HTTPS",
                     "label_w": 1.0},
                    {"from": "fw", "to": "web"},
                    {"from": "identity", "to": "web", "label": "認証",
                     "label_w": 0.9},
                    {"from": "web", "to": "db", "label": "SQL", "label_w": 0.8},
                    {"from": "web", "to": "log", "label": "監査ログ",
                     "label_w": 1.2, "dash": "dash"},
                    {"from": "db", "to": "backup", "label": "日次",
                     "label_w": 0.8, "dash": "dash"},
                ],
            },
        },
        {
