    ...
    "slides": [
        ...
        },
        {
            ...
            "steps": [
                ...
                {"name": "検証", "desc": "PNG化・機械検知・目視で崩れを確認する。", "actor": "コード + 人間"},
                {"name": "提出", "desc": "指摘があればcontentを直し、手動修正せず再生成する。", "actor": "人間"},
            ],
            "emph": [3],
        },
        {
            ...
            "phases": [
                ...
                {"name": "Phase 2  現場検証", "goal": "週次資料で試行", "bar": "3部署でパイロット", "start": 2, "end": 4.5},
                {"name": "Phase 3  標準化", "goal": "レビュー手順に組込", "bar": "品質ゲートを標準運用", "start": 4.5, "end": 6},
            ],
            "milestones": [
                {"at": 2, "row": 0, "label": "型レビュー"},
                {"at": 4.5, "row": 1, "label": "展開判断"},
                {"at": 6, "row": 2, "label": "標準化"},
            ],
        },
        {
            "type": "matrix",
